...
POLLUTANT_BREAKPOINTS = {
    ...
    'no2': [(0, 40, 0, 50), (41, 80, 51, 100), (81, 180, 101, 200), (181, 280, 201, 300), (281, 400, 301, 400), (401, 520, 401, 500)],
    'o3': [(0, 50, 0, 50), (51, 100, 51, 100), (101, 168, 101, 200), (169, 208, 201, 300), (209, 748, 301, 400), (749, 1288, 401, 500)],
    'co': [(0, 1.0, 0, 50), (1.1, 2.0, 51, 100), (2.1, 10.0, 101, 200), (10.1, 17.0, 201, 300), (17.1, 34.0, 301, 400), (34.1, 51.0, 401, 500)],
...
def calculate_sub_index(value, pollutant):
    ...
    for bp_low, bp_high, aqi_low, aqi_high in breakpoints:
        ...
        elif value > bp_high and breakpoints[-1] == (bp_low, bp_high, aqi_low, aqi_high):
            return aqi_high
    return None 
